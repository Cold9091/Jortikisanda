      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold font-montserrat mb-4 text-foreground">JortikiSanda</h3>
          ...
          <div>
            <h4 className="text-lg font-semibold font-montserrat mb-4 text-foreground">Serviços</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold font-montserrat mb-4 text-foreground">Contato</h4>
            <ul className="space-y-2 text-muted-foreground">
